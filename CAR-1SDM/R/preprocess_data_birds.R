## [[file:preprocess_data_birds.org::*Necessary libraries][Necessary libraries:1]]
    setwd("R")
    #library("CAR-1SDM")
## Necessary libraries:1 ends here

## [[file:preprocess_data_birds.org::*Necessary libraries][Necessary libraries:2]]
    library(CARBayes)
## Necessary libraries:2 ends here

## [[file:preprocess_data_birds.org::*Necessary libraries][Necessary libraries:3]]
    library(dplyr)
    library(purrr)
    library(reticulate)
## Necessary libraries:3 ends here

## [[file:preprocess_data_birds.org::*Loading the /choosing principle/ functions][Loading the /choosing principle/ functions:1]]
source("ChoosingPrinciples.R")
## Loading the /choosing principle/ functions:1 ends here

## [[file:preprocess_data_birds.org::*Read the adjancency matrix of the spatial lattice][Read the adjancency matrix of the spatial lattice:1]]
...
## [[file:preprocess_data_birds.org::*Read /training/ dataframe][Read /training/ dataframe:1]]
...
## [[file:preprocess_data_birds.org::*Generating relative absences with the /choosing principle/][Generating relative absences with  the /choosing principle/:1]]
...
## [[file:preprocess_data_birds.org::*Preprocess adjancency matrix $M$][Preprocess adjancency matrix $M$:1]]
...
## [[file:preprocess_data_birds.org::*Preprocess adjancency matrix $M$][Preprocess adjancency matrix $M$:2]]
