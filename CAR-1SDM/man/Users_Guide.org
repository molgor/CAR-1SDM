#+TITLE: A users' guide to apply the presence-only joint distribution framework for single species
#+AUTHOR: Juan Escamilla Molgora, Luigi Sedda, Peter Diggle, Peter Atkinson
#+EMAIL: j.escamillamolgora@lancaster.ac.uk
#+LANGUAGE: en
#+EXPORT_FILE_NAME: users-guide
#+SETUPFILE: https://fniessen.github.io/org-html-themes/org/theme-readtheorg.setup
#+LATEX_HEADER: \usepackage{tikz}
#+LATEX_HEADER: \usetikzlibrary{arrows,shapes,snakes,automata,backgrounds,petri,positioning}
#+LATEX_HEADER: \usepackage{svg}
#+OPTIONS: toc:nil        (no default TOC at all)
#+PROPERTY: header-args :session R :cache yes :exports both :tangle yes


#+BEGIN_abstract
This document is a guide to use the models described in the paper: /A joint distribution framework to improve presence-only species distribution models by exploiting opportunistic surveys/ (cite:EscamillaMolgora2021) for modelling species distributions with presence-only data. This users' guide represents a static version. For an updated (and possibly improved) version, refer to the interactive Jupyter notebook at [https://github.com/molgor/CAR-1SDM/blob/master/CAR-1SDM/notebooks/Users-guide.ipynb].
#+END_abstract
...
:Logbook:
We will compare these results with the Maximum Entropy algorithm (cite:Phillips2006), one of the most popular methods for estimating species distributions using presence-only observations. With these elements, the presented work provides a reproducible recipe for generating the results analysed  and discussed in the presented manuscript (cite:EscamillaMolgora2021).
:END:
...
#+CAPTION: Model I: Environmental Niche independent from Sampling Effort
#+LABEL: fig:M1
...
We will load the script init_data.R
...
#+RESULTS[f94b1a7af0341b631f5945e1ad263bb071a3edb1]:
...
#+CAPTION: Model II: Environmental Niche and Sampling Effort sharing a common spatial random effect
#+LABEL: fig:M2
#+begin_src latex :exports results
\begin{figure}
\label{fig:M2}
...
#+CAPTION: Model III: Environmental Niche and Sampling Effort with correlated spatial random effects
#+LABEL: fig:M3
#+begin_src latex :exports results
\begin{figure}
\label{fig:M3}
