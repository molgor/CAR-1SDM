...
CompleteCarSampler = function(X.standardised, K, p, beta, offset.temp, Y.DA, 
                              failures.DA, trials, prior.mean.beta, prior.var.beta, 
                              n.beta.block, proposal.sd.beta, list.block, Wtriplet, 
                              Wbegfin, Wtripletsum, phi, tau2, proposal.sd.phi,
                              theta,sigma2, proposal.sd.theta,iter_index) {
    ####################################
